...
public class Response   {
   ...
   * @return body
   **/
  @Schema(required = true, description = "The body of the response. For example for an HTTP response might contain HTML for rendering.")
      @NotNull
   ...
   * @return header
   **/
  @Schema(required = true, description = "Items included in the header of the response. For example for an HTTP response might contain negotiated locale.")
      @NotNull
    @Valid
