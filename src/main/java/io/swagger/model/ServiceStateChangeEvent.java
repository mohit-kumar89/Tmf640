...
import io.swagger.model.ServiceStateChangeEventPayload;
...
public class ServiceStateChangeEvent   {
  ...
  public ServiceStateChangeEvent eventTime(Date eventTime) {
  ...
  public ServiceStateChangeEvent timeOcurred(Date timeOcurred) {
