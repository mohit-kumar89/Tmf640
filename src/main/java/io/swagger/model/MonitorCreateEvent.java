...
import io.swagger.model.MonitorCreateEventPayload;
...
public class MonitorCreateEvent   {
  ...
  public MonitorCreateEvent eventTime(Date eventTime) {
  ...
  public MonitorCreateEvent timeOcurred(Date timeOcurred) {
